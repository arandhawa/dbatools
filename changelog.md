...
<!-- 
All entries prior for the next release to be added under a/the heading of "Unreleased".
Headings to be used:
- Fixed = issues fixed in the release
- Added = new commands/functions or significant features added (across the module in general)
- Removed = from the module or commands/functions
If nothing is added under a given heading, just put "No changes"
-->
